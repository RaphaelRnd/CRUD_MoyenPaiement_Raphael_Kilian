...
--
-- Current Database: `GSB_frais`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `GSB_frais` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `DAF` VALUES (1,'aaa','aaa','aaa','aaa');
...
INSERT INTO `Etat` VALUES ('CL','coucou'),('CR','fefd'),('RB','jesuisla'),('VA','hjhjb');
...
INSERT INTO `FicheFrais` VALUES ('a131','01',0,0.00,'2023-01-11','VA',1),('a131','12',67,78.00,'2022-12-05','RB',2),('b','01',0,0.00,'2023-01-18','VA',3),('b','02',0,0.00,'2023-02-01','CR',4);
...
INSERT INTO `LigneFraisForfait` VALUES ('a131','01','ETP',2),('a131','01','KM',90),('a131','01','NUI',5),('a131','01','REP',10),('b','01','ETP',0),('b','01','KM',0),('b','01','NUI',0),('b','01','REP',0),('b','02','ETP',0),('b','02','KM',0),('b','02','NUI',0),('b','02','REP',0);
...
CREATE TABLE `LigneFraisHorsForfait` (
  ...
  CONSTRAINT `LigneFraisHorsForfait_ibfk_3` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `FicheFrais` (`idVisiteur`, `mois`),
  CONSTRAINT `LigneFraisHorsForfait_ibfk_4` FOREIGN KEY (`idPaiement`) REFERENCES `Paiement` (`id`)
...
INSERT INTO `LigneFraisHorsForfait` VALUES (5,'a131','01','Test','2023-01-10',876.00,1),(6,'a131','12','Test','2022-12-02',7000.00,2),(11,'b','02','dzazs','2022-11-14',123.00,2),(17,'b','02','test','2022-12-14',153.00,1),(18,'b','02','je suis encore un test','2023-02-23',250.00,3),(19,'b','02','Caviar','2023-02-02',1000.00,4);
...
INSERT INTO `Paiement` VALUES (1,'Espèces'),(2,'Chèque'),(3,'Carte bancaire'),(4,'BitCoin');
...
-- Dump completed on 2023-02-02 14:49:08
